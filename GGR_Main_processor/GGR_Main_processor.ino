//  GGR Main processor     18/10/25
//   from pin reset      

//   BLINK() running to taste
...
//p  pin 6   cabinet blinker                  Timer 0
//  pin 6 could be released and used to digitally drive servo for shed point
//  maybe
//  Pin 7   E STOP LED
//  pin 8   see 12 below
...
//  pins 8 and 12 reprog active low    10/09
...
void setup() {
  ...
  pinMode(6, OUTPUT);   //  cabinet blinker
...
void EMGstop() {
  ...
  HoldOff = HIGH;
  digitalWrite(12, LOW);   //  power cut from rails
...
void RESET() {
  ...
  digitalWrite(8, HIGH);    //  with above
