//   Bunny Corner -  LDR in tree to control red kite
//   M Beer
...
//   24/08/21
//   A5 - LDR to stop red kite on tree

//   Train LDR detectors - EOR section
//   pins A1 and A2 LDRs 
...
void kite() {
  //  red kite one revolution
    Serial.println("kite");
  motor.step(60, FORWARD, MICROSTEP);  //  get clear of tree
    LDRtree = analogRead (A5);
  while (LDRtree < 250) {              //  light not obscured
